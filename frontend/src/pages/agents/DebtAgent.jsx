...
import { Loader2, RefreshCw, TrendingDown, Target, BarChart3 } from "lucide-react";
...
const DebtAgent = () => {
    ...
    const info = {
        ...
        icon: TrendingDown,
        color: "#ef4444",
        description: "Strategies to be debt-free."
    };
            ...
            {!data ? (
                <Card className="border-dashed border-2 bg-muted/20">
                    <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                        ...
                        <p className="text-muted-foreground mb-6 max-w-md">Get personalized AI insights for your debt repayment specific specifically tailored to your financial profile.</p>
                ...
                <div className="grid gap-6 md:grid-cols-12">
                    <Card className="col-span-12 md:col-span-8 shadow-sm">
                        <CardHeader>
                            ...
                            <CardDescription>Visual analysis of your debt reduction timeline</CardDescription>
                        </CardHeader>
