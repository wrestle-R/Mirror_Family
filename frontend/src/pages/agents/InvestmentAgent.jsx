...
import { Loader2, RefreshCw, TrendingUp, Target, BarChart3 } from "lucide-react";
            ...
            {!data ? (
                <Card className="border-dashed border-2 bg-muted/20">
                    <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                        ...
                        <p className="text-muted-foreground mb-6 max-w-md">Get personalized AI insights for your investment strategy specifically tailored to your financial profile.</p>
